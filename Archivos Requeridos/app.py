...
# Load data from csv
def load_data():
    # Cargar el archivo CSV, convertir la columna de fecha a datetime
    # y establecerla como índice del DataFrame
    current_dir = os.path.dirname(__file__)
    csv_path = os.path.join(current_dir, "datos_energia.csv")
...
def description_card():
    ...
    return html.Div(
        ...
        children=[
            #html.H5("Proyecto 1"),
            html.H3("Pronóstico de producción energética TALLER2-SECCION4: COLABORANDO"),
            html.Div(
                id="intro",
